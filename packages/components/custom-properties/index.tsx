                            ...
                            <div className='mt-2'>
                                ...
                                <div className='flex flex-col gap-3'>
                                    ...
                                    {properties.map((property, index) => (
                                        <div key={index} className='border border-gray-700 p-3 rounded-lg bg-gray-900'>
                                            <div className='flex items-center justify-between'>
                                                ...
                                                <button type='button' onClick={() => removeProperty(index)}> <X size={20} /> </button>
                                            </div>
                                            ...
                                            <div className='flex items-center mt-2 gap-2'>
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => addValue(index)}> Add </button>
                                            </div>
                                    ...
                                    <div className='flex items-center gap-2 mt-1'>
                                        <Input
                                            placeholder='Enter property label (e.g., Material, Warranty, etc.)'
                                            value={newLabel}
                                            onChange={(e: any) => setNewLabel(e.target.value)} />

                                        <button
                                            type='button'
                                            className='px-3 py-2 bg-blue-500 text-white rounded-md flex justify-center'
                                            onClick={addProperty}>
                                            <PlusCircle size={20} /> Add
                                        </button>
                                    </div>
                                </div>
                                {errors?.custom_properties && <p className='text-red-500 text-xs mt-1'>
