...
const Page = () => {
    ...
    const [seletedSizes, setSelectedSizes] = useState<string[]>([]);
    ...
    const updateURL = () => {
        ...
        if (seletedSizes?.length > 0) params.set("sizes", seletedSizes.join(","));
    ...
    const fetchFilteredProducts = async () => {
        ...
        try {
            ...
            if (seletedSizes?.length > 0) query.set("sizes", seletedSizes.join(","));
    ...
    }, [priceRange, selectedCategories, seletedSizes, selectedColors, page]);
                    ...
                    <aside className='w-full lg:w-[270px] !rounded bg-white p-4 space-y-6 shadow-md'>
                        ...
                        <div className='flex justify-between items-center mt-2'>
                            <div className='text-sm text-gray-600'>
                                P{tempPriceRange[0]} - P{tempPriceRange[1]}
                            </div>
                            <button
                                onClick={() => {
                            ...
                            {colors.map((color) => (
                                ...
                                >
                                    <label className='flex items-center gap-2 cursor-pointer text-sm text-gray-700'>
                                        <input type="checkbox" checked={selectedColors.includes(color.name)} onChange={() => toggleColor(color.name)}
                                            className='accent-blue-600' />
                            ...
                            {sizes.map((size) => (
                                ...
                                >
                                    <label className='flex items-center gap-3 cursor-pointer text-sm text-gray-700'>
                                        <input type="checkbox" checked={seletedSizes.includes(size)} onChange={() => toggleSize(size)}
                                            className='accent-blue-600' />
