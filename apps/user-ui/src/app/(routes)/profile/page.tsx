                ...
                <div className='mt-10 flex flex-col md:flex-row gap-6'>
                    ...
                    <div className='bg-white p-4 rounded-md shadow-sm border border-gray-100 w-full md:w-1/5'>
                        <nav className='space-y-2'>
                            ...
                            <NavItem label="Logout" Icon={LogOut} active={activeTab === 'Logout'} danger onClick={() => logOutHandler()} />
                        </nav>
                    </div>
                    ...
                    <div className='w-full md:w-1/4 space-y-4'>
                        ...
                        <QuickActionCard Icon={PhoneCall} title="Support Center" description="Need help? Contact our team" />
                    </div>
...
const NavItem = ({ label, Icon, active, danger, onClick }: any) => (
    <button onClick={onClick} className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition ${active ? 'bg-blue-100 text-blue-600' : danger ? 'text-red-500 hover:bg-red-50' : 'text-gray-700 hover:bg-gray-100'
        } `}>
